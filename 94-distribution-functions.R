...
# Plot normal curve
plot(x, y, type="l", lwd=1, ylab="dnorm(x)", xlab="x")
...
arrows(3, 0.13, 2, dnorm(2), col="red", length=0.1)
text(3, 0.15, paste0("dnorm(2) = ", round(dnorm(2), 3)), col="red")
...
text(2, 0.38, paste0("pnorm(2) = ", round(pnorm(2), 3)), col="black")

#-------------

# qnorm(0.977)
arrows(3.8, 0.05, 2, 0, col="blue", length=0.1)
text(3.8, 0.07, paste0("qnorm(0.977) = ", round(qnorm(0.977), 0)), col="blue")
...
text(-3, 0.12, "rnorm(50)", col="darkgreen")
